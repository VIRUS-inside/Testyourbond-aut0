  ...
  extends IdScriptableObject
{
  ...
  protected void initPrototypeId(int id) {
    ...
    int arity;
    String s; initPrototypeMethod(ITERATOR_TAG, id, s, arity);
  }
  ...
  private static Object jsConstructor(Context cx, Scriptable scope, Scriptable thisObj, Object[] args)
  {
    ...
    result.setPrototype(ScriptableObject.getClassPrototype(scope, result
      .getClassName()));
  ...
  private Object next(Context cx, Scriptable scope) {
    Boolean b = ScriptRuntime.enumNext(objectIterator);
    if (!b.booleanValue())
    {
  ...
  public static class WrappedJavaIterator { private Iterator<?> iterator;
    ...
    WrappedJavaIterator(Iterator<?> iterator, Scriptable scope) { this.iterator = iterator;
      this.scope = scope;
    }
