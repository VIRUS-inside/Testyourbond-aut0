...
class DToA
{
  ...
  private static BigInteger d2b(double d, int[] e, int[] bits)
  {
    ...
    if ((de = d0 >>> 20) != 0)
      z |= 0x100000;
    int y;
    int i; byte[] dbl_bits; int k; int i; if ((y = d1) != 0) {
  ...
  static String JS_dtobasestr(int base, double d) {
    ...
    long lfloor = dfloor;
    String intDigits; String intDigits; if (lfloor == dfloor)
    {
      ...
      long mantissa;
      long mantissa; if (exp == 0) {
        mantissa = (floorBits & 0xFFFFFFFFFFFFF) << 1;
      } else {
        mantissa = floorBits & 0xFFFFFFFFFFFFF | 0x10000000000000;
      }
      if (negative) {
        mantissa = -mantissa;
      }
  ...
  static int JS_dtoa(double d, int mode, boolean biasUp, int ndigits, boolean[] sign, StringBuilder buf)
  {
    ...
    if ((word0(d) & 0x80000000) != 0)
    {
      sign[0] = true;
      
      d = setWord0(d, word0(d) & 0x7FFFFFFF);
    } else {
      sign[0] = false;
    }
    ...
    boolean denorm; double d2; boolean denorm; if ((i = word0(d) >>> 20 & 0x7FF) != 0) {
      double d2 = setWord0(d, word0(d) & 0xFFFFF | 0x3FF00000);
    ...
    if ((ilim >= 0) && (ilim <= 14) && (try_quick))
    {
      ...
      if (ilim == 0) { BigInteger mhi;
        BigInteger S = mhi = null;
        d -= 5.0D;
        if (d > eps) {
          buf.append('1');
          k++;
    ...
    {
      ds = tens[k];
      if ((ndigits < 0) && (ilim <= 0)) { BigInteger mhi;
        BigInteger S = mhi = null;
    ...
    int m2 = b2;
    int m5 = b5;
    BigInteger mlo; BigInteger mhi = mlo = null;
    if (leftright) {
      if (mode < 2) {
    ...
    if ((mode < 2) && 
      (word1(d) == 0) && ((word0(d) & 0xFFFFF) == 0) && 
      ((word0(d) & 0x7FE00000) != 0))
    {
    ...
    if ((ilim <= 0) && (mode > 2))
    {
      ...
      if ((ilim < 0) || 
        ((i = b.compareTo(
        S = S.multiply(BigInteger.valueOf(5L)))) < 0) || ((i == 0) && (!biasUp)))
      {
    ...
    if (leftright) {
      ...
      for (i = 1;; i++) {
        BigInteger[] divResult = b.divideAndRemainder(S);
        b = divResult[1];
        char dig = (char)(divResult[0].intValue() + 48);
        ...
        if ((j < 0) || ((j == 0) && (mode == 0) && 
          ...
          if (j1 > 0)
          {
            ...
            b = b.shiftLeft(1);
            j1 = b.compareTo(S);
            if ((j1 > 0) || ((j1 == 0) && (((dig & 0x1) == '\001') || (biasUp)))) { dig = (char)(dig + '\001'); if (dig == '9')
              {
  ...
  static void JS_dtostr(StringBuilder buffer, int mode, int precision, double d)
  {
    ...
    if ((sign[0] != 0) && ((word0(d) != Integer.MIN_VALUE) || (word1(d) != 0)) && (
      ((word0(d) & 0x7FF00000) != 2146435072) || ((word1(d) == 0) && 
      ((word0(d) & 0xFFFFF) == 0)))) {
      buffer.insert(0, '-');
    }
  }
