...
public class Conversions
{
  ...
  public static int toUint8(Object arg) { int iv;
    int iv;
    if ((arg instanceof Integer)) {
      iv = ((Integer)arg).intValue();
    } else {
  ...
  public static int toInt16(Object arg) { int iv;
    int iv;
    if ((arg instanceof Integer)) {
      iv = ((Integer)arg).intValue();
    } else {
  ...
  public static int toUint16(Object arg) { int iv;
    int iv;
    if ((arg instanceof Integer)) {
      iv = ((Integer)arg).intValue();
    } else {
  ...
  public static int toInt32(Object arg) {
    long lv = ScriptRuntime.toNumber(arg);
