  ...
  extends IdScriptableObject
{
  ...
  protected void fillConstructorProperties(IdFunctionObject ctor)
  {
    ...
    ProtoProps protoProps = new ProtoProps(null);
  ...
  public String toString()
  {
    ...
    return (toString instanceof String) ? (String)toString : 
      super.toString();
  }
  ...
  protected void initPrototypeId(int id) {
    ...
    int arity;
    String s; initPrototypeMethod(ERROR_TAG, id, s, arity);
  }
  ...
  public void setStackProvider(RhinoException re)
  {
    if ((stackProvider == null) && 
      (Context.getContext().hasFeature(106))) {
      stackProvider = re;
  ...
  public Object getStackDelegated(Scriptable target)
  {
    ...
    if (prepare == null) {
      ...
      Object value = RhinoException.formatStackTrace(stack, stackProvider
        .details());
