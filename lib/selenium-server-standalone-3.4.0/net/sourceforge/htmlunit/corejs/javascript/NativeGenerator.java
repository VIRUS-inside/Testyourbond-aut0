  ...
  extends IdScriptableObject
{
  ...
  public String getClassName() { return "Generator"; }
  
  public static class GeneratorClosedException extends RuntimeException { private static final long serialVersionUID = 2561315658662379681L;
    
    public GeneratorClosedException() {}
  }
  
  private static class CloseGeneratorAction implements ContextAction { CloseGeneratorAction(NativeGenerator generator) { this.generator = generator; }
  ...
  protected void initPrototypeId(int id) { String s;
    ...
    int arity;
    String s; initPrototypeMethod(GENERATOR_TAG, id, s, arity);
  }
  ...
  public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args)
  {
    ...
    case 3: 
      ...
      if ((firstTime) && (!arg.equals(Undefined.instance))) {
