  ...
  implements Function
{
  ...
  public static void init(Context cx, Scriptable scope, boolean sealed) { NativeContinuation obj = new NativeContinuation();
  ...
  protected void initPrototypeId(int id)
  {
    ...
    int arity;
    String s; initPrototypeMethod(FTAG, id, s, arity);
  }
