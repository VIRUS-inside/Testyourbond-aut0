...
public class Decompiler
{
  ...
  public static String decompile(String source, int flags, UintMap properties)
  {
    ...
    int i = 0;
    int topFunctionType;
    int topFunctionType; if (source.charAt(i) == '') {
      i++;
      topFunctionType = -1;
    } else {
    ...
    while (i < length) {
      ...
      case ' ': 
        ...
        break;
      case '\002': case '\003': case '\005': case '\006': case '\007': case '\b': case '!': case '"': case '#': case '$': case '%': case '&': case '1': case '3': case '6': case '7': case '8': case '9': 
      case ':': case ';': case '<': case '=': case '>': case '?': case '@': case 'A': case 'C': case 'D': case 'E': case 'F': case 'G': case 'I': case 'J': case 'K': case 'L': case 'M': 
      case 'N': case 'O': case 'P': case 'n': case 'o': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': 
      case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '': case '¡': case '¢': case '£': default: 
  ...
  private static int printSourceNumber(String source, int offset, StringBuilder sb)
  {
    ...
    if (type == 'S') {
      ...
      if (sb != null)
      {
        long lbits = source.charAt(offset) << 48;
