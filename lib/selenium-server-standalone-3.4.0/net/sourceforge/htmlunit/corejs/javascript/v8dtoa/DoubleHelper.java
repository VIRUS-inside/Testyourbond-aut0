...
public class DoubleHelper
{
  ...
  static int exponent(long d64) {
    ...
    int biased_e = (int)((d64 & 0x7FF0000000000000) >>> 52 & 0xFFFFFFFF);
  ...
  {
    return (d64 & 0x7FF0000000000000) == 9218868437227405312L;
  }
  
  static boolean isNan(long d64) {
    return ((d64 & 0x7FF0000000000000) == 9218868437227405312L) && ((d64 & 0xFFFFFFFFFFFFF) != 0L);
  }
  ...
  static void normalizedBoundaries(long d64, DiyFp m_minus, DiyFp m_plus)
  {
    ...
    m_plus.setE(v.e() - 1);
    m_plus.normalize();
    if ((significand_is_zero) && (v.e() != 64462))
    {
