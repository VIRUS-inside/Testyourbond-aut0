  ...
  extends IdScriptableObject
{
  ...
  protected void initPrototypeId(int id) { String s;
    ...
    String s;
    String s;
    String s; String s; String s; switch (id) {
    case 1: 
      int arity = 1;
      s = "constructor";
      break;
    ...
    int arity;
    String s; initPrototypeMethod(NUMBER_TAG, id, s, arity);
  }
  
  private static final int Id_toString = 2;
  private static final int Id_toLocaleString = 3;
  private static final int Id_toSource = 4;
  public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) { if (!f.hasTag(NUMBER_TAG)) {
