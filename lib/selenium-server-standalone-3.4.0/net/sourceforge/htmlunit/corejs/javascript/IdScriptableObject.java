  ...
  implements IdFunctionCall
{
    ...
    implements Serializable
  {
    ...
    final void delete(int id) {
      ...
      if ((attr & 0x4) == 0) {
        int valueSlot = (id - 1) * 2;
        synchronized (this) {
          valueArray[valueSlot] = Scriptable.NOT_FOUND;
          attributeArray[(id - 1)] = 0;
        }
      }
    }
    ...
    final Object[] getNames(boolean getAll, Object[] extraEntries) {
      ...
      for (int id = 1; id <= maxId; id++) {
        Object value = ensureId(id);
        if (((getAll) || ((attributeArray[(id - 1)] & 0x2) == 0)) && 
  ...
  {
    throw ScriptRuntime.constructError("InternalError", "Changing attributes not supported for " + 
      getClassName() + " " + 
  ...
  public final void initPrototypeMethod(Object tag, int id, String name, int arity)
  {
    ...
    prototypeValues.initValue(id, name, f, 2);
  }
  ...
  public final void initPrototypeConstructor(IdFunctionObject f) {
    ...
    prototypeValues.initValue(id, "constructor", f, 2);
  }
