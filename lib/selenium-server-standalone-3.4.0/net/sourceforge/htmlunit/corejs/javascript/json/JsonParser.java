...
public class JsonParser
{
  ...
  public synchronized Object parseValue(String json) throws JsonParser.ParseException {
    if (json == null) {
  ...
  private int fromHex(char c) {
    return (c >= 'a') && (c <= 'f') ? c - 'a' + 10 : (c >= 'A') && (c <= 'F') ? c - 'A' + 10 : (c >= '0') && (c <= '9') ? c - '0' : -1;
  }
  ...
  {
    return new ParseException("Unsupported number format: " + src
      .substring(start, end));
  }
