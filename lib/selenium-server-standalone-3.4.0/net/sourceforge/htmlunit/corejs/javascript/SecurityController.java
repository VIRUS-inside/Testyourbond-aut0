...
public abstract class SecurityController
{
  ...
  public static GeneratedClassLoader createLoader(ClassLoader parent, Object staticDomain)
  {
    ...
    GeneratedClassLoader loader; if (sc == null) {
  ...
  {
    execWithDomain(cx, scope, new Script()
    {
      public Object exec(Context cx, Scriptable scope) { return callable.call(cx, scope, thisObj, args); } }, securityDomain);
  }
