...
final class FactoryFinder
{
    ...
    throws FactoryFinder.ConfigurationError
  {
    ...
    return find(paramString1, localClassLoader, paramString2);
  }
    ...
    throws FactoryFinder.ConfigurationError
  {
    ...
    try
    {
      ...
      if ((str1 != null) && (str1.length() > 0))
      {
        ...
        return newInstance(str1, paramClassLoader, true);
      }
    }
    ...
    try
    {
      ...
      String str3 = str2 + File.separator + "lib" + File.separator + "stax.properties";
      String str4 = null;
      if (firstTime) {
      ...
      {
        if (debug) {
          dPrint("found in $java.home/stax.properties, value=" + str4);
        }
        return newInstance(str4, paramClassLoader, true);
      }
    }
    catch (Exception localException)
    {
