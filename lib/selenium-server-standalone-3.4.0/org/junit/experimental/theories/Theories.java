  ...
  extends BlockJUnit4ClassRunner
{
  ...
  public static class TheoryAnchor extends Statement {
    ...
    protected void runWithCompleteAssignment(final Assignments complete) throws Throwable
    {
      new BlockJUnit4ClassRunner(getTestClass().getJavaClass())
      {
          ...
          new Statement()
          {
            public void evaluate() throws Throwable {
              try {
                ...
                reportParameterizedError(e, val$complete.getArgumentStrings(Theories.TheoryAnchor.this.nullsOk()));
              }
            }
          };
        }
        ...
        public Object createTest() throws Exception
        {
          ...
          return getTestClass().getOnlyConstructor().newInstance(params); } }.methodBlock(testMethod).evaluate();
    }
    ...
    {
      Theory annotation = (Theory)testMethod.getMethod().getAnnotation(Theory.class);
