  ...
  static class MethodParameterValue extends PotentialAssignment
  {
    ...
    public Object getValue() throws PotentialAssignment.CouldNotGenerateValueException
    {
      try {
        ...
        DataPoint annotation = (DataPoint)method.getAnnotation(DataPoint.class);
        org.junit.Assume.assumeTrue((annotation == null) || (!AllMembersSupplier.isAssignableToAnyOf(annotation.ignoredExceptions(), throwable)));
