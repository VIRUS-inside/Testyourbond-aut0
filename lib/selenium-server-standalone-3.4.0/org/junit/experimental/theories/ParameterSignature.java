...
public class ParameterSignature
{
  ...
  private static Map<Class<?>, Class<?>> buildConvertableTypesMap() { Map<Class<?>, Class<?>> map = new HashMap();
  ...
  public boolean canAcceptValue(Object candidate) {
    return candidate == null ? false : !type.isPrimitive() ? true : canAcceptType(candidate.getClass());
  }
