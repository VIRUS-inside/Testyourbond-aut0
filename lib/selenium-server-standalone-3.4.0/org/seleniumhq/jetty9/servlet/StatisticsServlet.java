  ...
  extends HttpServlet
{
  ...
  public void init() throws ServletException { ServletContext context = getServletContext();
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
  {
    ...
    if (Boolean.valueOf(req.getParameter("statsReset")).booleanValue())
    {
    ...
    if (Boolean.valueOf(wantXml).booleanValue())
    {
  ...
  private void sendXmlResponse(HttpServletResponse response)
    throws IOException
  {
    ...
    for (Connector connector : _connectors)
    {
      ...
      if ((connector instanceof AbstractConnector))
        connectionStats = (ConnectionStatistics)((AbstractConnector)connector).getBean(ConnectionStatistics.class);
      ...
      else
      {
        ...
        if ((connector instanceof AbstractConnector))
          connectorStats = (ConnectorStatistics)((AbstractConnector)connector).getBean(ConnectorStatistics.class);
  ...
  private void sendTextResponse(HttpServletResponse response) throws IOException
  {
    ...
    for (Connector connector : _connectors)
    {
      ...
      if ((connector instanceof Container))
        connectionStats = (ConnectionStatistics)((Container)connector).getBean(ConnectionStatistics.class);
      if (connectionStats != null)
      {
