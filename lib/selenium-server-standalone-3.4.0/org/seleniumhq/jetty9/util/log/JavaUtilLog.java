  ...
  extends AbstractLogger
{
  ...
  private static final boolean __source = Boolean.parseBoolean(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.SOURCE", Log.__props
    .getProperty("org.seleniumhq.jetty9.util.log.javautil.SOURCE", "true")));
  ...
  public JavaUtilLog()
  {
    this("org.seleniumhq.jetty9.util.log.javautil");
  }
  ...
  public JavaUtilLog(String name)
  {
    synchronized (JavaUtilLog.class)
    {
      if (!_initialized)
      {
        ...
        final String properties = Log.__props.getProperty("org.seleniumhq.jetty9.util.log.javautil.PROPERTIES", null);
        if (properties != null)
        {
