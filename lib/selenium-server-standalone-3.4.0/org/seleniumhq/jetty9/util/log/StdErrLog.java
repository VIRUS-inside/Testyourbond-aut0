  ...
  extends AbstractLogger
{
  ...
  private static int __tagpad = Integer.parseInt(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.StdErrLog.TAG_PAD", "0"));
  
  private static DateCache _dateCache;
  private static final boolean __source = Boolean.parseBoolean(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.SOURCE", Log.__props
    .getProperty("org.seleniumhq.jetty9.util.log.stderr.SOURCE", "false")));
  private static final boolean __long = Boolean.parseBoolean(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.stderr.LONG", "false"));
  private static final boolean __escape = Boolean.parseBoolean(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.stderr.ESCAPE", "true"));
  
  static
  {
    String[] deprecatedProperties = { "DEBUG", "org.seleniumhq.jetty9.util.log.DEBUG", "org.seleniumhq.jetty9.util.log.stderr.DEBUG" };
    ...
    if (_source)
    {
      ...
      for (int i = 0; i < frames.length; i++)
      {
        ...
        if ((!clazz.equals(StdErrLog.class.getName())) && (!clazz.equals(Log.class.getName())))
        {
          ...
          if ((!_printLongNames) && (clazz.startsWith("org.seleniumhq.jetty9.")))
          {
