  ...
  extends Handler
{
  ...
  {
    if (Boolean.parseBoolean(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.DEBUG", "false")))
    {
      setLevel(Level.FINEST);
    }
    
    if (Boolean.parseBoolean(Log.__props.getProperty("org.seleniumhq.jetty9.util.log.IGNORED", "false")))
    {
      setLevel(Level.ALL);
    }
