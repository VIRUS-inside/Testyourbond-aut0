...
public class IntrospectionUtil
{
    ...
    throws NoSuchMethodException
  {
    ...
    {
      if (methods[i].getName().equals(methodName)) { if (checkParams(methods[i].getParameterTypes(), args == null ? new Class[0] : args, strictArgs))
        {
          method = methods[i];
        }
      }
  ...
  public static boolean isSameSignature(Method methodA, Method methodB)
  {
    ...
    {
      if (parameterTypesA.containsAll(parameterTypesB))
        return true;
    }
    return false;
  }
