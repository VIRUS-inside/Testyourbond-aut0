  ...
  implements WebDriver, JavascriptExecutor, TakesScreenshot, WrapsDriver, HasInputDevices, HasTouchScreen
{
  ...
  private final WebDriverEventListener dispatcher = (WebDriverEventListener)Proxy.newProxyInstance(WebDriverEventListener.class
    .getClassLoader(), new Class[] { WebDriverEventListener.class }, new InvocationHandler()
  {
  ...
  public EventFiringWebDriver(final WebDriver driver)
  {
    ...
    this.driver = ((WebDriver)Proxy.newProxyInstance(WebDriverEventListener.class
      .getClassLoader(), allInterfaces, new InvocationHandler()
      {
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
        {
  ...
  {
    return new EventFiringTargetLocator(driver.switchTo(), null);
  }
  ...
  public WebDriver.Options manage() {
    return new EventFiringOptions(driver.manage(), null);
  }
  
  private WebElement createWebElement(WebElement from) {
    return new EventFiringWebElement(from, null);
  }
  ...
  private class EventFiringWebElement implements WebElement, WrapsElement, WrapsDriver, Locatable
  {
    ...
    {
      this.element = ((WebElement)Proxy.newProxyInstance(WebDriverEventListener.class
        .getClassLoader(), EventFiringWebDriver.this
    ...
    public List<WebElement> findElements(By by) {
      dispatcher.beforeFindBy(by, this.element, driver);
      List<WebElement> temp = this.element.findElements(by);
      dispatcher.afterFindBy(by, this.element, driver);
      List<WebElement> result = new ArrayList(temp.size());
      for (WebElement element : temp) {
  ...
  private class EventFiringOptions implements WebDriver.Options
  {
    ...
    public WebDriver.Timeouts timeouts() {
      return new EventFiringWebDriver.EventFiringTimeouts(EventFiringWebDriver.this, options.timeouts());
    }
    ...
    public WebDriver.Window window() {
      return new EventFiringWebDriver.EventFiringWindow(EventFiringWebDriver.this, options.window());
    }
  }
  ...
  private class EventFiringTargetLocator implements WebDriver.TargetLocator
  {
    ...
    public Alert alert() {
      return new EventFiringWebDriver.EventFiringAlert(EventFiringWebDriver.this, targetLocator.alert(), null);
    }
  }
