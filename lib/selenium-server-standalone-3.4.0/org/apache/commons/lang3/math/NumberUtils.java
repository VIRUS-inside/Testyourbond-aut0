...
public class NumberUtils
{
    ...
    throws NumberFormatException
  {
    ...
    String mant;
    String dec;
    if (decPos > -1) { String dec;
      String dec; if (expPos > -1) {
    ...
    if ((!Character.isDigit(lastChar)) && (lastChar != '.')) { String exp;
      String exp; if ((expPos > -1) && (expPos < str.length() - 1)) {
