...
public class ArrayUtils
{
  ...
  public static <T> T[] add(T[] array, T element)
  {
    ...
    if (array != null) {
      type = array.getClass().getComponentType(); } else { Class<?> type;
      if (element != null) {
  ...
  {
    return (Object[])removeAll(array, indices);
  }
  ...
  public static <T> T[] removeElements(T[] array, T... values)
  {
    ...
    Object result = (Object[])removeAll(array, toRemove);
    return result;
  }
  ...
  public static byte[] removeElements(byte[] array, byte... values)
  {
    ...
    for (int i = 0; i < array.length; i++) {
      byte key = array[i];
      MutableInt count = (MutableInt)occurrences.get(Byte.valueOf(key));
      if (count != null) {
        if (count.decrementAndGet() == 0) {
  ...
  public static short[] removeElements(short[] array, short... values)
  {
    ...
    for (int i = 0; i < array.length; i++) {
      short key = array[i];
      MutableInt count = (MutableInt)occurrences.get(Short.valueOf(key));
      if (count != null) {
        if (count.decrementAndGet() == 0) {
  ...
  public static int[] removeElements(int[] array, int... values)
  {
    ...
    for (int i = 0; i < array.length; i++) {
      int key = array[i];
      MutableInt count = (MutableInt)occurrences.get(Integer.valueOf(key));
      if (count != null) {
        if (count.decrementAndGet() == 0) {
  ...
  public static long[] removeElements(long[] array, long... values)
  {
    ...
    for (int i = 0; i < array.length; i++) {
      long key = array[i];
      MutableInt count = (MutableInt)occurrences.get(Long.valueOf(key));
      if (count != null) {
        if (count.decrementAndGet() == 0) {
  ...
  public static double[] removeElements(double[] array, double... values)
  {
    ...
    for (int i = 0; i < array.length; i++) {
      double key = array[i];
      MutableInt count = (MutableInt)occurrences.get(Double.valueOf(key));
      if (count != null) {
        if (count.decrementAndGet() == 0) {
  ...
  public static boolean[] removeElements(boolean[] array, boolean... values)
  {
    ...
    BitSet toRemove = new BitSet();
    for (int i = 0; i < array.length; i++) { int k;
      int k = array[i];
      MutableInt count = (MutableInt)occurrences.get(Boolean.valueOf(k));
      if (count != null) {
        if (count.decrementAndGet() == 0) {
          occurrences.remove(Boolean.valueOf(k));
        }
        toRemove.set(i);
      }
    }
