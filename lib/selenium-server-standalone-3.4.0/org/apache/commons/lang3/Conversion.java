...
public class Conversion
{
    ...
    if ((src.length > srcPos + 3) && (src[(srcPos + 3)] != 0)) {
      if ((src.length > srcPos + 2) && (src[(srcPos + 2)] != 0)) {
        if ((src.length > srcPos + 1) && (src[(srcPos + 1)] != 0)) {
          return src[srcPos] != 0 ? 'f' : 'e';
        }
        return src[srcPos] != 0 ? 'd' : 'c';
      }
      if ((src.length > srcPos + 1) && (src[(srcPos + 1)] != 0)) {
        return src[srcPos] != 0 ? 'b' : 'a';
      }
      return src[srcPos] != 0 ? '9' : '8';
    }
    if ((src.length > srcPos + 2) && (src[(srcPos + 2)] != 0)) {
      if ((src.length > srcPos + 1) && (src[(srcPos + 1)] != 0)) {
        return src[srcPos] != 0 ? '7' : '6';
      }
      return src[srcPos] != 0 ? '5' : '4';
    }
    if ((src.length > srcPos + 1) && (src[(srcPos + 1)] != 0)) {
      return src[srcPos] != 0 ? '3' : '2';
    }
    return src[srcPos] != 0 ? '1' : '0';
  }
  ...
  public static char binaryToHexDigitMsb0_4bits(boolean[] src, int srcPos)
  {
    ...
    if (src[(srcPos + 3)] != 0) {
      if (src[(srcPos + 2)] != 0) {
        if (src[(srcPos + 1)] != 0) {
          return src[srcPos] != 0 ? 'f' : '7';
        }
        return src[srcPos] != 0 ? 'b' : '3';
      }
      if (src[(srcPos + 1)] != 0) {
        return src[srcPos] != 0 ? 'd' : '5';
      }
      return src[srcPos] != 0 ? '9' : '1';
    }
    if (src[(srcPos + 2)] != 0) {
      if (src[(srcPos + 1)] != 0) {
        return src[srcPos] != 0 ? 'e' : '6';
      }
      return src[srcPos] != 0 ? 'a' : '2';
    }
    if (src[(srcPos + 1)] != 0) {
      return src[srcPos] != 0 ? 'c' : '4';
    }
    return src[srcPos] != 0 ? '8' : '0';
  }
  ...
  public static char binaryBeMsb0ToHexDigit(boolean[] src, int srcPos)
  {
    ...
    if (src[srcPos] != 0) {
      if ((src.length > srcPos + 1) && (src[(srcPos + 1)] != 0)) {
        if ((src.length > srcPos + 2) && (src[(srcPos + 2)] != 0)) {
          return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? 'f' : 'e';
        }
        return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? 'd' : 'c';
      }
      if ((src.length > srcPos + 2) && (src[(srcPos + 2)] != 0)) {
        return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? 'b' : 'a';
      }
      return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? '9' : '8';
    }
    if ((src.length > srcPos + 1) && (src[(srcPos + 1)] != 0)) {
      if ((src.length > srcPos + 2) && (src[(srcPos + 2)] != 0)) {
        return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? '7' : '6';
      }
      return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? '5' : '4';
    }
    if ((src.length > srcPos + 2) && (src[(srcPos + 2)] != 0)) {
      return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? '3' : '2';
    }
    return (src.length > srcPos + 3) && (src[(srcPos + 3)] != 0) ? '1' : '0';
  }
