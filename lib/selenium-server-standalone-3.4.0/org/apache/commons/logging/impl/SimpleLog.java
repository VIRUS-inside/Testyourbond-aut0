  ...
  implements Log, Serializable
{
  ...
  protected void log(int type, Object message, Throwable t)
  {
    ...
    switch (type) {
    case 1:  buf.append("[TRACE] "); break;
    case 2:  buf.append("[DEBUG] "); break;
    case 3:  buf.append("[INFO] "); break;
    case 4:  buf.append("[WARN] "); break;
    case 5:  buf.append("[ERROR] "); break;
    case 6:  buf.append("[FATAL] ");
    }
  ...
  private static InputStream getResourceAsStream(String name) {
    (InputStream)AccessController.doPrivileged(new PrivilegedAction() {
      ...
      public Object run() { ClassLoader threadCL = SimpleLog.access$000();
