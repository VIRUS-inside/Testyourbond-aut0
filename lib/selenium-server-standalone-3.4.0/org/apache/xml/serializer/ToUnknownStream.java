  ...
  extends SerializerBase
{
  ...
  private void emitFirstTag() throws SAXException
  {
    if (m_firstElementName != null)
    {
      ...
      if (m_namespacePrefix != null)
      {
        int n = m_namespacePrefix.size();
        for (int i = 0; i < n; i++)
        {
          String prefix = (String)m_namespacePrefix.elementAt(i);
          
          String uri = (String)m_namespaceURI.elementAt(i);
  ...
  {
    boolean isHTML = getLocalNameUnknown(m_firstElementName).equalsIgnoreCase("html");
    ...
    if ((isHTML) && (m_namespacePrefix != null))
    {
      ...
      int max = m_namespacePrefix.size();
      for (int i = 0; i < max; i++)
      {
        String prefix = (String)m_namespacePrefix.elementAt(i);
        String uri = (String)m_namespaceURI.elementAt(i);
