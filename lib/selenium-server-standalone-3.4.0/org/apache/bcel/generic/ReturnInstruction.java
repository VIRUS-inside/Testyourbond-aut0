  ...
  implements ExceptionThrower, TypedInstruction, StackConsumer
{
  ...
  public Type getType() {
    switch (opcode) {
    case 172:  return Type.INT;
    case 173:  return Type.LONG;
    case 174:  return Type.FLOAT;
    case 175:  return Type.DOUBLE;
    case 176:  return Type.OBJECT;
    case 177:  return Type.VOID;
    }
