  ...
  extends Attribute
{
    ...
    throws InternalError
  {
    ...
    switch (c.getTag()) {
    case 5:  buf = "" + ((ConstantLong)c).getBytes(); break;
    case 4:  buf = "" + ((ConstantFloat)c).getBytes(); break;
    case 6:  buf = "" + ((ConstantDouble)c).getBytes(); break;
    case 3:  buf = "" + ((ConstantInteger)c).getBytes(); break;
    case 8: 
      int i = ((ConstantString)c).getStringIndex();
      c = constant_pool.getConstant(i, (byte)1);
      buf = "\"" + convertString(((ConstantUtf8)c).getBytes()) + "\"";
      break;
    case 7: default:  throw new InternalError("Type of ConstValue invalid: " + c);
    }
