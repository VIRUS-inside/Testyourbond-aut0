  ...
  extends JFrame
{
  ...
  private void jbInit() throws Exception
  {
    ...
    classNamesJList.setSelectionMode(0);
    ...
    newFileMenuItem.setAccelerator(KeyStroke.getKeyStroke(78, 2, true));
    ...
    jSplitPane2.add(messagesPanel, "bottom");
  ...
  synchronized void pass3aJList_valueChanged(ListSelectionEvent e)
  {
    ...
    pass3aTextPane.setBackground(rejected ? Color.red : all3aok ? Color.green : Color.yellow);
  }
