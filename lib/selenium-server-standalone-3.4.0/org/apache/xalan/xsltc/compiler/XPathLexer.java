  ...
  implements Scanner
{
    ...
    throws Exception
  {
    ...
    return ((yy_buffer[index] == ':') && (yy_buffer[(index + 1)] == ':')) || (yy_buffer[index] == '(') ? newSymbol(ss) : newSymbol(28, yytext());
  }
  ...
  Symbol newSymbol(int ss) { last = ss;
    return new Symbol(ss);
  }
  
  Symbol newSymbol(int ss, String value) { last = ss;
    return new Symbol(ss, value);
  }
  
  Symbol newSymbol(int ss, Long value) { last = ss;
    return new Symbol(ss, value);
  }
  
  Symbol newSymbol(int ss, Double value) { last = ss;
    return new Symbol(ss, value);
  }
  ...
  private void yy_mark_start() { yy_buffer_start = yy_buffer_index; }
    ...
    throws IOException, Exception
  {
    ...
    for (;;) { int yy_lookahead;
      int yy_lookahead;
      if ((yy_initial) && (yy_at_bol)) yy_lookahead = 65536; else
      ...
      if (-1 != yy_next_state) {
        ...
        case -21: 
          break;
        case 21: 
          return newSymbol(52, new Long(yytext()));
        case -22: 
          break;
        case 22: 
          return newSymbol(15);
        ...
        case -28: 
          break;
        case 28: 
          return newSymbol(51, new Double(yytext()));
        case -29: 
          break;
        case 29: 
          return newSymbol(17);
        ...
        case -32: 
          break;
        case 32: 
          return newSymbol(27, yytext().substring(1, yytext().length() - 1));
        case -33: 
          break;
        ...
        case -38: 
          break;
        case 38: 
          return disambiguateAxisOrFunction(30);
        case -39: 
          break;
        case 39: 
          return disambiguateOperator(34);
        case -40: 
          break;
        case 40: 
        ...
        case -48: 
          break;
        case 48: 
          initialize();return new Symbol(53);
        case -49: 
          break;
        case 49: 
        ...
        case -51: 
          break;
        case 51: 
          return disambiguateAxisOrFunction(50);
        case -52: 
          break;
        case 52: 
        ...
        case -56: 
          break;
        case 56: 
          initialize();return new Symbol(54);
        case -57: 
          break;
        case 57: 
        ...
        case -201: 
          break;
        case 0: case 64: case 69: case 72: case 75: case 78: case 80: case 82: case 84: case 86: case 88: case 90: case 92: case 94: case 96: case 98: case 100: case 102: case 104: case 106: case 108: case 110: case 112: case 114: case 116: case 118: case 120: case 122: case 124: case 126: case 185: case 186: case 188: case 190: default: 
          yy_error(0, false);
        }
