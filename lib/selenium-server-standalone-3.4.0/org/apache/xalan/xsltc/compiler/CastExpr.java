  ...
  extends Expression
{
    ...
    throws TypeCheckError
  {
    ...
    throw new TypeCheckError(new ErrorMsg("DATA_CONVERSION_ERR", tleft.toString(), _type.toString()));
  }
    ...
    else
    {
      ...
      if (_type != ltype) {
        ...
        if ((_type instanceof BooleanType)) {
          FlowList fl = ltype.translateToDesynthesized(classGen, methodGen, _type);
