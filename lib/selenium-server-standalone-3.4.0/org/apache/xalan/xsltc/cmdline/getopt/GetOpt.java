...
public class GetOpt
{
  ...
  static class Option
  {
    ...
    public void setArg(String arg) { theArgument = arg; }
  ...
  {
    public OptionMatcher(String optString) { theOptString = optString; }
    ...
    public boolean hasArg(char c) { boolean retval = false;
