  ...
  extends ExtensionHandler
{
  ...
  public ExtensionHandlerGeneral(String namespaceUri, StringVector elemNames, StringVector funcNames, String scriptLang, String scriptSrcURL, String scriptSrc, String systemId)
    ...
    if (m_scriptSrcURL != null)
    {
      ...
      catch (MalformedURLException mue)
      {
        ...
        if ((indexOfColon != -1) && (indexOfSlash != -1) && (indexOfColon < indexOfSlash))
        {
          ...
          url = null;
          throw new TransformerException(XSLMessages.createMessage("ER_COULD_NOT_FIND_EXTERN_SCRIPT", new Object[] { m_scriptSrcURL }), mue);
        }
        ...
        {
          throw new TransformerException(XSLMessages.createMessage("ER_COULD_NOT_FIND_EXTERN_SCRIPT", new Object[] { m_scriptSrcURL }), mue2);
        }
      }
      ...
      if (url != null)
      {
        ...
        {
          throw new TransformerException(XSLMessages.createMessage("ER_COULD_NOT_FIND_EXTERN_SCRIPT", new Object[] { m_scriptSrcURL }), ioe);
        }
      }
    }
    ...
    throws TransformerException
  {
    try
    {
      ...
      if (m_engineCall == null) {
        m_engineCall = m_engine.getClass().getMethod("call", new Class[] { Object.class, String.class, new Object[0].getClass() });
      }
