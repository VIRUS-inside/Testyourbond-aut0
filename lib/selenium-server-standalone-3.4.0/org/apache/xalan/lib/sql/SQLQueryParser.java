...
public class SQLQueryParser
{
  ...
  private void parse(XConnection xconn, int override)
  {
    ...
    if (override == 1) { m_InlineVariables = false;
    } else if (override == 2) { m_InlineVariables = true;
    }
  ...
  public void registerOutputParameters(CallableStatement cstmt)
    throws SQLException
  {
