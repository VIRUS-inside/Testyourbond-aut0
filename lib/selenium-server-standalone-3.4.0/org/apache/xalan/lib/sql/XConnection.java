...
public class XConnection
{
  ...
  public DTM query(ExpressionContext exprContext, String queryString)
  {
    ...
    try
    {
      if (null == m_ConnectionPool) { DTM localDTM = null;return localDTM;
      }
      SQLQueryParser query = m_QueryParser.parse(this, queryString, 1);
  ...
  public DTM pquery(ExpressionContext exprContext, String queryString, String typeInfo)
  {
    ...
    try
    {
      ...
      SQLQueryParser query = m_QueryParser.parse(this, queryString, 0);
  ...
  private void addParameters(Element elem)
  {
    ...
    do {
      if (n.getNodeType() == 1)
      {
        ...
        String TypeStr;
        String TypeStr;
        if (Type == null) TypeStr = "string"; else {
  ...
  private SQLErrorDocument buildErrorDocument()
  {
    ...
    if (m_LastSQLDocumentWithError != null)
    {
      ...
      try
      {
        ...
        eDoc = new SQLErrorDocument(mgr, dtmIdent << 16, m_Error, warn, m_FullErrors);
