  ...
  extends ElemUse
{
  ...
  {
    isLiteralResultAsStylesheet = false;
  ...
  {
    if ((uri == null) || ((null == m_excludeResultPrefixes) && (null == m_ExtensionElementURIs)))
    {
  ...
  {
    if ((null == m_excludeResultPrefixes) && (null == getPrefixTable()) && (m_ExtensionElementURIs == null))
    {
  ...
  public class LiteralElementAttributes implements NamedNodeMap {
    ...
    public int getLength()
    {
      if (m_count == -1)
      {
        if (null != m_avts) m_count = m_avts.size(); else
          m_count = 0;
      }
      return m_count;
    }
      ...
      while (eum.hasNext()) {
        ...
        if (localName.equals(avt.getName()))
        {
          ...
          if (((uri == null) && (nsURI == null)) || ((uri != null) && (uri.equals(nsURI))))
          {
            ...
            retNode = new ElemLiteralResult.Attribute(ElemLiteralResult.this, avt, ElemLiteralResult.this);
            break;
          }
        }
      }
    ...
    public Node item(int i)
    {
      ...
      return new ElemLiteralResult.Attribute(ElemLiteralResult.this, (AVT)m_avts.get(i), ElemLiteralResult.this);
    }
    ...
    public Node removeNamedItem(String name)
      throws DOMException
    {
      throwDOMException((short)7, "NO_MODIFICATION_ALLOWED_ERR");
  ...
  public class Attribute implements Attr {
    ...
    {
      return new Attribute(ElemLiteralResult.this, m_attribute, m_owner);
    }
