  ...
  extends AbstractLogger
{
  ...
  public LoggerLog(Object logger)
  {
    try
    {
      ...
      _debugMAA = lc.getMethod("debug", new Class[] { String.class, [Ljava.lang.Object.class });
      _infoMT = lc.getMethod("info", new Class[] { String.class, Throwable.class });
      _infoMAA = lc.getMethod("info", new Class[] { String.class, [Ljava.lang.Object.class });
      _warnMT = lc.getMethod("warn", new Class[] { String.class, Throwable.class });
      _warnMAA = lc.getMethod("warn", new Class[] { String.class, [Ljava.lang.Object.class });
