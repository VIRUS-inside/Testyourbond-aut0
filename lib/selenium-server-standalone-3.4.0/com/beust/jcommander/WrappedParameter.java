...
public class WrappedParameter
{
  ...
  {
    try {
      Method m = findPut(parameterized.getType());
      m.invoke(parameterized.get(object), new Object[] { key, value });
  ...
  private Method findPut(Class<?> cls) throws SecurityException, NoSuchMethodException {
    return cls.getMethod("put", new Class[] { Object.class, Object.class });
  }
