  ...
  implements DragSourceListener, DragSourceMotionListener, DragGestureListener
{
  ...
  protected boolean canDrag(DragGestureEvent e)
  {
    ...
    if (mods == 64)
      return (supportedActions & 0x2) != 0;
    if (mods == COPY_MASK)
      return (supportedActions & 0x1) != 0;
    if (mods == LINK_MASK)
      return (supportedActions & 0x40000000) != 0;
    return true;
  }
  ...
  protected Image createDragImage(GraphicsConfiguration gc, Icon icon)
  {
    ...
    g.setComposite(AlphaComposite.getInstance(2, ghostAlpha));
  ...
  static String actionString(int action) {
    switch (action) {
    case 2:  return "MOVE";
    case 3:  return "MOVE|COPY";
    case 1073741826:  return "MOVE|LINK";
    case 1073741827:  return "MOVE|COPY|LINK";
    case 1:  return "COPY";
    case 1073741825:  return "COPY|LINK";
    case 1073741824:  return "LINK"; }
    return "NONE";
  }
