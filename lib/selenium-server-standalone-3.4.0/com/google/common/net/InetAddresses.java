...
public final class InetAddresses
{
  ...
  private static byte[] textToNumericFormatV6(String ipString)
  {
    ...
    if (skipIndex >= 0)
    {
      ...
      if (parts[0].length() == 0) { partsHi--; if (partsHi != 0)
          return null;
      }
      if (parts[(parts.length - 1)].length() == 0) { partsLo--; if (partsLo != 0) {
          return null;
        }
      }
    }
  ...
  public static InetAddress decrement(InetAddress address)
  {
    ...
    Preconditions.checkArgument(i >= 0, "Decrementing %s would wrap.", address); int 
    
      tmp47_46 = i; byte[] tmp47_45 = addr;tmp47_45[tmp47_46] = ((byte)(tmp47_45[tmp47_46] - 1));
    return bytesToInetAddress(addr);
  }
  ...
  public static InetAddress increment(InetAddress address)
  {
    ...
    Preconditions.checkArgument(i >= 0, "Incrementing %s would wrap.", address); int 
    
      tmp48_47 = i; byte[] tmp48_46 = addr;tmp48_46[tmp48_47] = ((byte)(tmp48_46[tmp48_47] + 1));
    return bytesToInetAddress(addr);
  }
