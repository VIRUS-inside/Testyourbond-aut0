  ...
  extends AbstractGraphBuilder<N>
{
  ...
  public static <N, E> NetworkBuilder<N, E> from(Network<N, E> network)
  {
    return 
      ...
      new NetworkBuilder(network.isDirected()).allowsParallelEdges(network.allowsParallelEdges()).allowsSelfLoops(network.allowsSelfLoops()).nodeOrder(network.nodeOrder()).edgeOrder(network.edgeOrder());
  }
  ...
  public <N1 extends N> NetworkBuilder<N1, E> nodeOrder(ElementOrder<N1> nodeOrder)
  {
    ...
    nodeOrder = ((ElementOrder)Preconditions.checkNotNull(nodeOrder));
    return newBuilder;
  }
  ...
  public <E1 extends E> NetworkBuilder<N, E1> edgeOrder(ElementOrder<E1> edgeOrder)
  {
    ...
    edgeOrder = ((ElementOrder)Preconditions.checkNotNull(edgeOrder));
    return newBuilder;
  }
