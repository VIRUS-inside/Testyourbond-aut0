  ...
  extends AbstractDirectedNetworkConnections<N, E>
{
  ...
  private Multiset<N> predecessorsMultiset() {
    Multiset<N> predecessors = (Multiset)getReference(predecessorsReference);
  ...
  private Multiset<N> successorsMultiset() {
    Multiset<N> successors = (Multiset)getReference(successorsReference);
    if (successors == null) {
  ...
  {
    new MultiEdgesConnecting(outEdgeMap, node)
    {
      public int size() {
