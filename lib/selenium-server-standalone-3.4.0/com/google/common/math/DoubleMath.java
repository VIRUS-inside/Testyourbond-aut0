...
public final class DoubleMath
{
  ...
  public static int log2(double x, RoundingMode mode)
  {
    ...
    boolean increment;
    boolean increment;
    boolean increment; switch (1.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
    case 1: 
  ...
  {
    return (DoubleUtils.isFinite(x)) && ((x == 0.0D) || 
    
      (52 - Long.numberOfTrailingZeros(DoubleUtils.getSignificand(x)) <= Math.getExponent(x)));
  }
