    ...
    new TypeVisitor()
    {
      ...
      void visitParameterizedType(ParameterizedType fromParameterizedType)
      {
        ...
        if ((fromParameterizedType.getOwnerType() != null) && 
          ...
          TypeResolver.populateTypeMappings(val$mappings, fromParameterizedType
  ...
  private static class TypeTable
  {
    ...
    Type resolveInternal(TypeVariable<?> var, TypeTable forDependants)
    {
      ...
      if (type == null) {
        ...
        return Types.newArtificialTypeVariable(var
    ...
    Type capture(Type type) {
      ...
      if ((type instanceof WildcardType)) {
        ...
        if (lowerBounds.length == 0) {
          ...
          return Types.newArtificialTypeVariable(WildcardCapturer.class, name, wildcardType
            .getUpperBounds());
        }
