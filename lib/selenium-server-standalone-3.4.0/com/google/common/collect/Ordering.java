  ...
  implements Comparator<T>
{
  ...
  protected Ordering() {}
  private static class ArbitraryOrderingHolder { private ArbitraryOrderingHolder() {}
  ...
  static class ArbitraryOrdering extends Ordering<Object> { private final AtomicInteger counter;
    ArbitraryOrdering() { counter = new AtomicInteger(0); }
    
    private final ConcurrentMap<Object, Integer> uids = Platform.tryWeakKeys(new MapMaker()).makeMap();
    
    private Integer getUid(Object obj) {
      Integer uid = (Integer)uids.get(obj);
      if (uid == null)
      {


        uid = Integer.valueOf(counter.getAndIncrement());
        Integer alreadySet = (Integer)uids.putIfAbsent(obj, uid);
        if (alreadySet != null) {
          uid = alreadySet;
        }
      }
