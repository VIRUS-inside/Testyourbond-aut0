...
public final class Booleans
{
    ...
    implements Comparator<Boolean>
  {
    ...
    {
      int aVal = a.booleanValue() ? trueValue : 0;
      int bVal = b.booleanValue() ? trueValue : 0;
      return bVal - aVal;
    }
  ...
  public static boolean[] concat(boolean[]... arrays)
  {
    ...
    int pos = 0;
    boolean[][] arrayOfBoolean2 = arrays;boolean[] array = arrayOfBoolean2.length; for (boolean[] arrayOfBoolean3 = 0; arrayOfBoolean3 < array; arrayOfBoolean3++) { boolean[] array = arrayOfBoolean2[arrayOfBoolean3];
  ...
  private static enum LexicographicalComparator implements Comparator<boolean[]> {
    ...
    public int compare(boolean[] left, boolean[] right) { int minLength = Math.min(left.length, right.length);
  ...
  private static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
    ...
    public boolean contains(Object target)
    {
      return ((target instanceof Boolean)) && 
        (Booleans.indexOf(array, ((Boolean)target).booleanValue(), start, end) != -1);
    }
