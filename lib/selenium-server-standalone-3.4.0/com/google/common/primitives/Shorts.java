...
public final class Shorts
{
  ...
  public static short[] concat(short[]... arrays)
  {
    ...
    int pos = 0;
    short[][] arrayOfShort2 = arrays;short[] array = arrayOfShort2.length; for (short[] arrayOfShort3 = 0; arrayOfShort3 < array; arrayOfShort3++) { short[] array = arrayOfShort2[arrayOfShort3];
  ...
  private static final class ShortConverter extends Converter<String, Short> implements Serializable
  {
    ...
    protected Short doForward(String value) { return Short.decode(value); }
  ...
  private static enum LexicographicalComparator implements Comparator<short[]> {
    ...
    public int compare(short[] left, short[] right) { int minLength = Math.min(left.length, right.length);
