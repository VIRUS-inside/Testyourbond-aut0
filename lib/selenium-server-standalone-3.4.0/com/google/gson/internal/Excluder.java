  ...
  implements TypeAdapterFactory, Cloneable
{
  ...
  protected Excluder clone() { try { return (Excluder)super.clone();
  ...
  public boolean excludeField(Field field, boolean serialize) {
    ...
    if ((version != -1.0D) && 
      (!isValidVersion((Since)field.getAnnotation(Since.class), (Until)field.getAnnotation(Until.class)))) {
      return true;
    }
    ...
    FieldAttributes fieldAttributes; if (!list.isEmpty()) {
  ...
  public boolean excludeClass(Class<?> clazz, boolean serialize) {
    if ((version != -1.0D) && 
      (!isValidVersion((Since)clazz.getAnnotation(Since.class), (Until)clazz.getAnnotation(Until.class)))) {
      return true;
    }
